...
export class EventService {
  ...
  getAllEventsTypes(page, size, sort): Observable<any> {
    return this.http.get<Event[]>(Constant.API_ENDPOINT + '/rest/groups',
    {
      params: {
        page: page,
        size: size,
  ...
  createEventType(EventData): Observable<Event[]> {
    return this.http.post<any>(Constant.API_ENDPOINT + '/rest/groups', EventData)
      .pipe(catchError(this.errorHandler));
  }
