...
import { EventTypeComponent } from '../eventsContents/event-type/event-type.component';
import { EventStockComponent } from '../eventsContents/event-stock/event-stock.component';
import { EventTypeManageComponent } from '../eventsContents/event-type-manage/event-type-manage.component';
import { EventRequestComponent } from '../eventsContents/event-request/event-request.component';
    ...
    children: [
        ...
        },
        {
          ...
          children: [
            ...
            {path: 'types', component: EventTypeComponent},
            {path: 'stock', component: EventStockComponent},
            {path: 'details/:id', component: EventDetailsComponent},
            {path: 'new', component: EventsManageComponent, canActivate: [AdminAuthGuard]},
            {path: 'newtype', component: EventTypeManageComponent, canActivate: [AdminAuthGuard]},
            {path: 'newrequest', component: EventRequestComponent, canActivate: [AdminAuthGuard]}
          ]
        },
